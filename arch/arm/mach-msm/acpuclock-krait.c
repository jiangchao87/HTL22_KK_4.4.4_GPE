...
#define LOWERCLOCK_EXTRA_FREQS	5
#else
#define LOWERCLOCK_EXTRA_FREQS	0
#endif

#define NORMAL_FREQ_TABLE_SIZE	35

#define FREQ_TABLE_SIZE		(NORMAL_FREQ_TABLE_SIZE + LOWERCLOCK_EXTRA_FREQS + OVERCLOCK_EXTRA_FREQS)
