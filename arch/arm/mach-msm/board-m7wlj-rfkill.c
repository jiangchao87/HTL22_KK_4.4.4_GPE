...
struct pm8xxx_gpio_init m7wl_bt_pmic_gpio[] = {
	PM8XXX_GPIO_INIT(BT_SHUTDOWNz, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, \
...
static void m7wl_GPIO_config_bt_on(void)
{
	...
	gpio_set_value(PM8921_GPIO_PM_TO_SYS(BT_SHUTDOWNz), 0);
	mdelay(5);
	...
	gpio_set_value(PM8921_GPIO_PM_TO_SYS(BT_SHUTDOWNz), 1);
